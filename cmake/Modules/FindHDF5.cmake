...
if(CMAKE_BUILD_TYPE MATCHES "^Debug$")
    find_library(hdf5_hl_cpp_LIBRARY NAMES hdf5_hl_cpp_D libhdf5_hl_cpp_D hdf5_hl_cpp_debug hdf5_hl_cpp libhdf5_hl_cpp)
    find_library(hdf5_cpp_LIBRARY NAMES hdf5_cpp_D libhdf5_cpp_D hdf5_cpp_debug hdf5_cpp libhdf5_cpp)
    find_library(hdf5_hl_LIBRARY NAMES hdf5_hl_D libhdf5_hl_D hdf5_hl_debug hdf5_hl libhdf5_hl)
    find_library(hdf5_LIBRARY NAMES hdf5_D libhdf5_D hdf5_debug hdf5 libhdf5)
else()
...
if(HDF5_FOUND AND NOT TARGET HDF5::hdf5_hl_cpp)
    ...
    set_target_properties(HDF5::hdf5_hl_cpp PROPERTIES
        ...
        INTERFACE_COMPILE_DEFINITIONS "HDF5_hdf5_hl_cpp_FOUND;HDF5_FOUND"
...
if(HDF5_FOUND AND NOT TARGET HDF5::hdf5_cpp)
    ...
    set_target_properties(HDF5::hdf5_cpp PROPERTIES
        ...
        INTERFACE_COMPILE_DEFINITIONS "HDF5_hdf5_cpp_FOUND;HDF5_FOUND"
        INTERFACE_INCLUDE_DIRECTORIES "${HDF5_INCLUDE_DIR}")
endif()
if(HDF5_FOUND AND NOT TARGET HDF5::hdf5_hl)
    ...
    set_target_properties(HDF5::hdf5_hl PROPERTIES
        ...
        INTERFACE_COMPILE_DEFINITIONS "HDF5_hdf5_hl_FOUND;HDF5_FOUND"
        INTERFACE_INCLUDE_DIRECTORIES "${HDF5_INCLUDE_DIR}")
endif()
if(HDF5_FOUND AND NOT TARGET HDF5::hdf5)
    ...
    set_target_properties(HDF5::hdf5 PROPERTIES
        ...
        INTERFACE_INCLUDE_DIRECTORIES "${HDF5_INCLUDE_DIR}"
        INTERFACE_LINK_LIBRARIES "ZLIB;${CMAKE_THREAD_LIBS_INIT};${CMAKE_DL_LIBS}")
endif()
