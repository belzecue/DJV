...
if(RtAudio_FOUND AND NOT TARGET RtAudio::rtaudio)
    ...
    set(RtAudio_INCLUDE_DIRECTORIES ${RtAudio_INCLUDE_DIR})
    set(RtAudio_LINK_LIBRARIES)
    if(WIN32)
    elseif(APPLE)
		set(RtAudio_LINK_LIBRARIES ${RtAudio_LINK_LIBRARIES} ${AUDIO_TOOLBOX} ${CORE_AUDIO} ${CORE_FOUNDATION})
    else()
		set(RtAudio_INCLUDE_DIRECTORIES ${RtAudio_INCLUDE_DIRECTORIES} ${ALSA_INCLUDE_DIR})
		set(RtAudio_LINK_LIBRARIES ${RtAudio_LINK_LIBRARIES} ${ALSA_LIBRARY})
        if(PULSE_LIB AND PULSESIMPLE_LIB)
    		set(RtAudio_INCLUDE_DIRECTORIES ${RtAudio_INCLUDE_DIRECTORIES} ${PULSE_INCLUDE_DIR} ${PULSESIMPLE_INCLUDE_DIR})
    		set(RtAudio_LINK_LIBRARIES ${RtAudio_LINK_LIBRARIES} ${PULSE_LIB} ${PULSESIMPLE_LIB})
        endif()
        if(JACK_LIB)
    		set(RtAudio_INCLUDE_DIRECTORIES ${RtAudio_INCLUDE_DIRECTORIES} ${JACK_INCLUDE_DIR})
    		set(RtAudio_LINK_LIBRARIES ${RtAudio_LINK_LIBRARIES} ${JACK_LIB})
        endif()
		set(RtAudio_LINK_LIBRARIES ${RtAudio_LINK_LIBRARIES} ${CMAKE_THREAD_LIBS_INIT})
    endif()
    set_target_properties(RtAudio::rtaudio PROPERTIES
        ...
        INTERFACE_INCLUDE_DIRECTORIES "${RtAudio_INCLUDE_DIRECTORIES}"
