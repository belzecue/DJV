...
if(GLFW_FOUND AND NOT TARGET GLFW::glfw)
    ...
    if(WIN32)
        set(GLFW_LINK_LIBRARIES ${GLFW_LINK_LIBRARIES} OpenGL::GL)
    elseif(APPLE)
	    set(GLFW_LINK_LIBRARIES ${GLFW_LINK_LIBRARIES} ${CORE_VIDEO} ${IO_KIT} ${COCOA} ${CARBON} OpenGL::GL)
    else()
		set(GLFW_INCLUDE_DIRECTORIES ${GLFW_INCLUDE_DIRECTORIES} ${X11_INCLUDE_DIR})
	    set(GLFW_LINK_LIBRARIES ${GLFW_LINK_LIBRARIES} ${X11_LIBRARIES} OpenGL::GL ${CMAKE_THREAD_LIBS_INIT} ${CMAKE_DL_LIBS})
    endif()
